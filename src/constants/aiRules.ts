export const MASTER_COPY_RULES = `# 🧠 DIRETRIZES DE CONVERSÃO IMOBILIÁRIA 2026
...
## 5. PESQUISA E CONTEXTO LOCAL (AUTORIDADE GEOGRÁFICA)
- **Pesquisa de Dados Reais:** A IA deve, obrigatoriamente, buscar em fontes confiáveis e verídicas na internet informações relevantes sobre o bairro e/ou a cidade informados (ex: IDH, novos investimentos, história, curiosidades ou infraestrutura de lazer).
- **Parágrafo de Localização:** Insira um parágrafo breve e envolvente ao final do anúncio para que o consumidor conheça mais sobre o estilo de vida e as vantagens da região.
